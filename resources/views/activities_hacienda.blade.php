                    ...
                    <li class="menu-item menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            @foreach ($property->activity as $activity)
                                <li class="menu-item">
                                    <a href="{{ url('hacienda-activities') }}#container_do_{{ $activity->id }}{{ $activity->name }}" class="BrownLL-Medium" style="font-size: 15px;">{{ $activity->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                    <li class="menu-item menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            @foreach ($property->wellness as $wellness)
                                <li class="menu-item">
                                    <a href="{{ url('hacienda-wellness') }}#container_well_{{ $wellness->id }}{{ $wellness->name }}" class="BrownLL-Medium" style="font-size: 15px;">{{ $wellness->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                ...
                <ul id="menu-menu-1" class="menu-nav menu-nav-1">
                    ...
                    <li class="menu-item menu-item-has-children">
                        ...
                        <ul class="sub-menu sub-menu-hacienda">
                            @foreach ($property->wellness as $wellness)
                                <li class="menu-item">
                                    <a href="{{ url('hacienda-wellness') }}#container_well_{{ $wellness->id }}{{ $wellness->name }}" class="Cinzel-Bold" style="cursor: pointer; font-size: 15px; color: #672100;">{{ $wellness->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
